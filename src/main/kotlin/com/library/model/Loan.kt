//отвечает за требование ТЗ «сущности Loan, LoanHistory, Fine». Loan — запись о выдаче с датами и статусом. LoanHistory — журнал всех изменений статуса (трассируемость операций). Fine — штраф с суммой и статусом оплаты.
