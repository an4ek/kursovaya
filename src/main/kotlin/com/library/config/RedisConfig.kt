//отвечает за требование ТЗ «Redis + @Cacheable». Настраивает подключение к Redis и сериализацию объектов, включая поддержку дат (LocalDateTime). Без этого файла кэш не заработает.
