//описывает что система отдаёт в ответ. Например карточка книги содержит название, автора, ISBN и количество доступных экземпляров. Здесь же метод from() который превращает JPA-сущность в JSON-ответ.
